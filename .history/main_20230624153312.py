...
def server_process_frame():
    ...
    handLandmarks_points, results = hand_detector.get_world_points(show_color_image, draw_finger=True)
    ...
    if results.multi_hand_landmarks:
        for handLms in results.multi_hand_landmarks:
            self.mpDraw.draw_landmarks(show_color_image, handLms, hand_detector.mpHands.HAND_CONNECTIONS, self.handLmsStyle, self.handConStyle)
