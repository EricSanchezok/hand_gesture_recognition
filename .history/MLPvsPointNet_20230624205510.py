...
def main():
    ...
    while True:
        ...
        landmarks_mlp = handworldLandmarks_points.copy()
        landmarks_pointnet = handworldLandmarks_points.copy()
        mlp_value, mlp_index = test_model_output(MLP_model, landmarks_mlp, mlp=True)
        pointnet_value, pointnet_index = test_model_output(Pointnet_model, landmarks_pointnet)
