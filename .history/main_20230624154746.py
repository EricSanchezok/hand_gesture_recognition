...
def main():
    ...
    while True:
        ...
        handLandmarks_points, results = hand_detector.get_world_points(show_color_image, draw_fingers=True)
        ...
        task_distributor.srv_value, kalman_fliter_init= task_distributor.handle_all_process(pred_index, kalman_fliter_3D_point)
        ...
        if saveMode:
            ...
            flip_handLandmarks_points, flip_result = flip_hand_detector.get_world_points(flip_show_color_image, draw_fingers=True)
