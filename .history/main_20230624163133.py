...
def main():
    ...
    while True:
        ...
        handworldLandmarks_points, handLandmarks_points = hand_detector.get_world_points(show_color_image, draw_fingers=True)

        most_index = process_gesture.get_pred(model, handworldLandmarks_points, print_pred_index=False)
        ...
        if saveMode:
            ...
            flip_handworldLandmarks_points, flip_handLandmarks_points = flip_hand_detector.get_world_points(flip_show_color_image, draw_fingers=True)
