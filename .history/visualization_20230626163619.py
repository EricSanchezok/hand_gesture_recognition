...
class plot_3D:
    ...
    def draw_3Dvalue(self, x_value, y_value, z_value):
        ...
        self.ax.set_zlabel('Z', fontdict={'size': 15, 'color': 'red'})
        self.ax.set_ylabel('Y', fontdict={'size': 15, 'color': 'red'})
        self.ax.set_xlabel('X', fontdict={'size': 15, 'color': 'red'})

        # 绘制散点图        
        self.ax.scatter3D(x, y, z, color=self.color, s=10)
        self.ax.scatter3D(self.x_t, self.y_t, self.z_t, color='blue', s=20)
