...
class realSense:
    ...
    def get_frame(self):
        ...
        return aligned_depth_frame, color_frame, camera_intrinsics
...
extrinsics = profile_color.get_extrinsics_to(profile_depth)
...
try:
    while True:
        ...
        aligned_depth_frame, color_frame, camera_intrinsics = L515.get_frame()
        ...
        if points is not None and not saveMode:
            ...
            fliter_point = pp.point_proccessing(points, results, ori_color_image, extrinsics, depth_scale, aligned_depth_frame, camera_intrinsics, dt)
            print(fliter_point)
