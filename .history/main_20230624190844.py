...
def main():
    ...
    while True:
        ...
        current_index = process_gesture.get_pred_index(model, handworldLandmarks_points, history_size = 5, print_pred_index=False)
        ...
        if save_data_mode:
            ...
            if most_index == 1:
                kalman_fliter_3D_point, target_image, kalman_fliter_init = process_point.point_proccessing(ori_color_image, aligned_depth_frame, handLandmarks_points, realSense_L515, kalman_fliter_init, dt)
