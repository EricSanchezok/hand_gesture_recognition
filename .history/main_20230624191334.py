...
def main():
    ...
    while True:
        ...
        if save_data_mode:
            ...
            if current_index == 1:
                kalman_fliter_3D_point, target_image, kalman_fliter_init = Point_3D_Tracking.point_proccessing(ori_color_image, aligned_depth_frame, handLandmarks_points, realSense_L515, kalman_fliter_init, dt)
