...
class DataSaver:
    ...
    def writeData(self, handworldLandmarks_points, label:int):
        print(handworldLandmarks_points.shape)
        for i in range(handworldLandmarks_points.shape[0]):
            self.file.write(handworldLandmarks_points[i][0].__str__() + ",")
...
class mediaPipeHand:
    ...
    def get_world_points(self, color_image, draw_fingers=True):
        ...
        return handworldLandmarks_points, handLandmarks_points