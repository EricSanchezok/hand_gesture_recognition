...
file_dir = "dataset/test_saveMode.csv"
...
def main():
    ...
    while True:
        ...
        show_color_image = frame.copy()

        print(show_color_image.shape)
        ...
        pred_index = pg.get_pred(points, angle_list, IsPrint=True)
        ...
        if not saveMode:
            ...
            #左右翻转
            flip_show_color_image = cv2.flip(frame, 1)
